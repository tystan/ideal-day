...
ui <- page(
  ...
  navset_card_pill(
    ...
    nav_panel(
      ...
      card(p(
        paste(
          "The aim of this app is to provide you with an idea of what the 'ideal' 24",
          "hours looks like to maximise your brain health and cognitive function.",
          "To do this, we will begin by asking you some questions about yourself and",
          "your current health. Then, based on this information, we will show you",
          "what the 'ideal' 24-hours looks like for the best possible cognitive function."
        )
      )), 
